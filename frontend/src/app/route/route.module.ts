...
export const appRoutes: Routes = [
  ...
  { path: 'statupdate', component: StatusComponent, canActivate: [AuthGuard] },
  {
    path: 'projects', canActivate: [AuthGuard],
    children: [
      {
        path: 'deatil/:id', component: ViewDetailComponent
      },
      {
        path: '', component: ViewAllComponent, pathMatch: 'full'
      }
    ]
  },
